const ccfRankList =
  ...
  "C	IROS	IEEERSJ International Conference on Intelligent Robots and Systems	IROS\n" +
...
for (x of ccfRankList.split("\n")) {
  y = x.split("\t");
  if (y[1] != "") {
    if (ccfRankAbbrName[y[1]] == undefined) {
      ccfRankAbbrName[y[1]] = {};
    }
    ccfRankAbbrName[y[1]][y[2]] = y[0];
  }
  ccfRankFullName[y[2]] = y[0];
  ccfRankDblpName[y[3]] = y[2];
}

const fs = require("fs");
fs.writeFileSync(
  "ccfRankAbbrName.js",
  "ccf.rankAbbrName = " + JSON.stringify(ccfRankAbbrName),
  "utf8"
);
fs.writeFileSync(
  "ccfRankFullName.js",
  "ccf.rankFullName = " + JSON.stringify(ccfRankFullName),
  "utf8"
);
fs.writeFileSync(
  "ccfRankDblpName.js",
  "ccf.rankDblpName = " + JSON.stringify(ccfRankDblpName),
  "utf8"
);
